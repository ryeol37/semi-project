...
<body>
   	...
   	<form action="adminBookWriteAction.action" method="post" enctype="multipart/form-data">
      ...
      <table width="800" border="0" cellspacing="1" cellpadding="1">
       ...
       <td align="right" colspan="2"><input name="submit" type="submit" value="작성완료" class="inputb"/> 
					<input name="list" type="button" value="목록" class="inputb" onClick="javascript:location.href='adminBookList.action?currentPage=<s:property value="currentPage" />'"/></td>
       </tr>
      </table>
