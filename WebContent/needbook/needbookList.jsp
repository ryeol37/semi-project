   ...
   <table width="720" border="0" cellspacing="0" cellpadding="2">
    ...
    <tr>
     ...
     <tbody>
      ...
      <s:url id="viewURL" action="needbookDetail">
            <s:param name="nb_no">
         ...
         <tr bgcolor="white" align="center">
            ...
            <td class="noppp" align="center"><s:a href="%{viewURL}"><s:property value="nb_subject" /></s:a></td>
             <td class="nopp" align="center"><s:property value="m_id" /></td>
            <td class="nopp" align="center"><s:property value="nb_regdate" /></td>
            <td class="nopp"><s:property value="nb_readhit" /></td>
            <td align="left">&nbsp;</td>
         </tr>
      </s:iterator>
      ...
      <s:if test="list.size() <= 0">
         ...
         <tr bgcolor="#FFFFFF" align="center">
            <td colspan="5">등록된 도서신청이 없습니다.</td>
         </tr>
         <tr bgcolor="#777777">
            <td height="1" colspan="5"></td>
         </tr>
