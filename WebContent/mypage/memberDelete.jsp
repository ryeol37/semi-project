...
<body>
<s:if test="${ session_pw != m_pw}">
   <div id="deletefrom">
      <div id="deletefromtop"></div>
<form action="memberDeleteAction.action">
      <div id="deletefrommiddle">

         <h2>Member Leave</h2><br><br>
         <h2>&nbsp;&nbsp;&nbsp;Need PassWord</h2>
         	

         <div id="pw_input">

            <div id="pw_inputleft"></div>

            <div id="pw_inputmiddle">
            ...
            <div id="pw_inputright"></div>

         </div>

         <div id="submit">

            <input type="image" src="style/image/login/member_leave.png" id="submit2"
               value="Sign In" onClick="return error_msg();" alt="checkId.action">
               <input type="hidden" id="m_pwr" name="m_pwr" value="${session_pw}">
         </div>
         <div id="links_right">
            <a href="main.action">No Leave</a>
         </div>
      </div>
      </form>
      <div id="deletefrombottom"></div>
   </div>
</s:if>
</body>
</html>